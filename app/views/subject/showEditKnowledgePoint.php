...
<article class="page-container">
       ...
       <input type="hidden" name = "id" value=<?=$kownledgepointid?>  >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>知识点：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?=$kownledgepoint['kownledgepointname']?>" placeholder="" id="adminName" name="name">
			</div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	$("#form-admin-add").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				type: 'post',
				url: "<?=url("Subject/editKnowledgePoint/")?>" ,
